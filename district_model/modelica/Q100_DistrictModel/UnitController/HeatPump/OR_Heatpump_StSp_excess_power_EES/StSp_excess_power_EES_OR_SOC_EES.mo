...
equation
    ...
    connect(Heatpump_Constants_storage_el_SOC_threshold, hysteresis_var.uLow)
      annotation (Line(points={{-120,-50},{-18,-50},{-18,-8},{-12,-8}},
          color={0,0,127}));
    connect(Heatpump_Constants_storage_el_SOC_threshold, gain.u)
      annotation (Line(points={{-120,-50},{-68,-50},{-68,20},{-62,20}},
          color={0,0,127}));
