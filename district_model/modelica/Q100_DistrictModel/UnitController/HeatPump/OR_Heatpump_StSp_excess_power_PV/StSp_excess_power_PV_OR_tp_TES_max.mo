...
equation
  connect(hysteresis_var.uHigh, Heatpump_Constants_tp_TES_max_set) annotation (
      Line(points={{-12,8},{-72,8},{-72,-50},{-120,-50}}, color={0,0,127}));
  ...
  connect(Heatpump_Constants_tp_TES_max_set, feedback.u1) annotation (Line(
        points={{-120,-50},{-72,-50},{-72,-26},{-58,-26}}, color={0,0,127}));
