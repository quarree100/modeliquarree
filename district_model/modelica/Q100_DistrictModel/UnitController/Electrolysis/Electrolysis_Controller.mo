...
model Electrolysis_Controller
  Electrolysis_StSp_priority_int electrolysis_StSp_priority_int
    annotation (Placement(transformation(extent={{-60,-90},{-40,-70}})));
  Electrolysis_StSp_priority_ext electrolysis_StSp_priority_ext(
      stSp_priority_ext_OR_Electrolysis_prio_ext(greaterThreshold(threshold=
            0.001)))
  ...
  Electrolysis_StSp_excess_power_PV electrolysis_StSp_excess_power_PV
    annotation (Placement(transformation(extent={{-60,-10},{-40,10}})));
  Electrolysis_StSp_excess_power_EES electrolysis_StSp_excess_power_EES
    annotation (Placement(transformation(extent={{-60,30},{-40,50}})));
  Modelica.Blocks.Interfaces.BooleanOutput Electrolysis_Specification_SI
    annotation (Placement(transformation(extent={{300,-130},{320,-110}})));
  Electrolysis_StSp_CO2_intensity electrolysis_StSp_CO2_intensity
    annotation (Placement(transformation(extent={{-60,70},{-40,90}})));
  Modelica.Blocks.Interfaces.RealInput signal_Electrolysis_prio_int annotation (
     Placement(transformation(extent={{-164,-112},{-140,-88}}),
        iconTransformation(extent={{-164,-112},{-140,-88}})));
  Modelica.Blocks.Interfaces.RealInput signal_Electrolysis_prio_ext annotation (
  ...
  Modelica.Blocks.Interfaces.RealInput Electrolysis_Constants_carbon_intensity_threshold
    "carbon intensity threshold" annotation (Placement(transformation(extent={{
            -164,68},{-140,92}}), iconTransformation(extent={{-164,68},{-140,92}})));
  ...
  Modelica.Blocks.Interfaces.RealInput Electrolysis_Constants_storage_el_SOC_threshold
    "Electrical storage charge status threshold" annotation (Placement(
        transformation(extent={{-164,28},{-140,52}}), iconTransformation(extent=
           {{-164,28},{-140,52}})));
  ...
  Modelica.Blocks.Interfaces.RealInput Electrolysis_Constants_P_el_min
  ...
  Modelica.Blocks.Interfaces.RealInput Electrolysis_Constants_T_TES_max_set
...
equation
  connect(electrolysis_StSp_priority_ext.Electrolysis_Specification_StSp_priority_ext_SI,
    or1.u1) annotation (Line(points={{-39,-40},{44,-40},{44,-60},{128,-60}},
        color={255,0,255}));
  connect(electrolysis_StSp_priority_int.Electrolysis_Specification_StSp_priority_int_SI,
  ...
  connect(or2.y, or4.u2) annotation (Line(points={{191,-20},{202,-20},{202,
            -18},{208,-18}},
                        color={255,0,255}));
  connect(electrolysis_StSp_excess_power_PV.Electrolysis_Specification_StSp_excess_power_PV_SI,
    or3.u2) annotation (Line(points={{-39,0},{44,0},{44,12},{128,12}}, color={
          255,0,255}));
  connect(electrolysis_StSp_excess_power_EES.Electrolysis_Specification_StSp_excess_power_EES_SI,
    or3.u1) annotation (Line(points={{-39,40},{44,40},{44,20},{128,20}}, color=
          {255,0,255}));
  connect(or4.y, Electrolysis_Specification_SI) annotation (Line(points={{231,-10},
          {250,-10},{250,-120},{310,-120}}, color={255,0,255}));
  connect(electrolysis_StSp_CO2_intensity.Electrolysis_Specification_StSp_CO2_intensity_SI,
    or4.u1) annotation (Line(points={{-39,80},{202,80},{202,-10},{208,-10}},
        color={255,0,255}));
  connect(electrolysis_StSp_priority_int.signal_Electrolysis_prio_int,
    signal_Electrolysis_prio_int) annotation (Line(points={{-62,-80},{-78,-80},
          {-78,-100},{-152,-100}}, color={0,0,127}));
  connect(electrolysis_StSp_priority_ext.signal_Electrolysis_prio_ext,
    signal_Electrolysis_prio_ext) annotation (Line(points={{-62,-45},{-70,-45},
          {-70,-120},{-152,-120}}, color={0,0,127}));
  connect(electrolysis_StSp_priority_ext.signal_Electrolysis_prio_int,
    signal_Electrolysis_prio_int) annotation (Line(points={{-62,-35},{-78,-35},
          {-78,-100},{-152,-100}}, color={0,0,127}));
  connect(electrolysis_StSp_excess_power_PV.signal_Electrolysis_prio_int,
    signal_Electrolysis_prio_int) annotation (Line(points={{-62,-6},{-78,-6},{-78,
          -100},{-152,-100}}, color={0,0,127}));
  connect(electrolysis_StSp_excess_power_EES.signal_Electrolysis_prio_int,
    signal_Electrolysis_prio_int) annotation (Line(points={{-62,34},{-78,34},{-78,
          -100},{-152,-100}}, color={0,0,127}));
  connect(electrolysis_StSp_CO2_intensity.signal_Electrolysis_prio_int,
    signal_Electrolysis_prio_int) annotation (Line(points={{-62,74},{-78,74},{-78,
          -100},{-152,-100}}, color={0,0,127}));
  connect(electrolysis_StSp_excess_power_EES.signal_Electrolysis_prio_ext,
    signal_Electrolysis_prio_ext) annotation (Line(points={{-62,31},{-70,31},{-70,
          -120},{-152,-120}}, color={0,0,127}));
  connect(electrolysis_StSp_CO2_intensity.signal_Electrolysis_prio_ext,
    signal_Electrolysis_prio_ext) annotation (Line(points={{-62,71},{-70,71},{-70,
          -120},{-152,-120}}, color={0,0,127}));
  connect(electrolysis_StSp_CO2_intensity.carbon_intensity, carbon_intensity)
    annotation (Line(points={{-62,89},{-62,90},{-106,90},{-106,100},{-152,100}},
        color={0,0,127}));
  connect(electrolysis_StSp_CO2_intensity.T_TES_unload, T_TES_unload)
    annotation (Line(points={{-62,82},{-102,82},{-102,20},{-152,20}}, color={0,
          0,127}));
  connect(electrolysis_StSp_CO2_intensity.T_DH_FF_set, T_DH_FF_set) annotation (
     Line(points={{-62,78},{-98,78},{-98,0},{-152,0}}, color={0,0,127}));
  connect(electrolysis_StSp_excess_power_EES.T_DH_FF_set, T_DH_FF_set)
    annotation (Line(points={{-62,38},{-98,38},{-98,0},{-152,0}}, color={0,0,
          127}));
  connect(electrolysis_StSp_excess_power_EES.T_TES_unload, T_TES_unload)
    annotation (Line(points={{-62,42},{-102,42},{-102,20},{-152,20}}, color={0,
          0,127}));
  connect(electrolysis_StSp_excess_power_EES.SOC_EES, SOC_EES) annotation (Line(
        points={{-62,49},{-62,48},{-106,48},{-106,60},{-152,60}}, color={0,0,
          127}));
  connect(electrolysis_StSp_excess_power_PV.P_el_renergy, P_el_renergy)
    annotation (Line(points={{-62,9},{-92,9},{-92,-20},{-152,-20}}, color={0,0,
          127}));
  connect(electrolysis_StSp_excess_power_PV.T_TES_load, T_TES_load) annotation (
     Line(points={{-62,2},{-86,2},{-86,-60},{-152,-60}}, color={0,0,127}));
  connect(electrolysis_StSp_excess_power_PV.signal_Electrolysis_prio_ext,
    signal_Electrolysis_prio_ext) annotation (Line(points={{-62,-9},{-62,-10},{
          -70,-10},{-70,-120},{-152,-120}}, color={0,0,127}));
  connect(Electrolysis_Specification_SI, Electrolysis_Specification_SI)
  ...
  connect(electrolysis_StSp_excess_power_EES.Electrolysis_Specification_StSp_excess_power_EES_SI,
    switch3.u2) annotation (Line(points={{-39,40},{44,40},{44,50},{82,50}},
        color={255,0,255}));
  connect(inputSignalCheck.u, Electrolysis_Constants_carbon_intensity_threshold)
    annotation (Line(points={{-128,80},{-152,80}}, color={0,0,127}));
  connect(inputSignalCheck.y, electrolysis_StSp_CO2_intensity.Electrolysis_Constants_carbon_intensity_threshold)
    annotation (Line(points={{-112,80},{-104,80},{-104,86},{-62,86}}, color={0,
          0,127}));
  connect(electrolysis_StSp_excess_power_EES.Electrolysis_Constants_storage_el_SOC_threshold,
    inputSignalCheck1.y) annotation (Line(points={{-62,46},{-106,46},{-106,40},
          {-112,40}}, color={0,0,127}));
  connect(inputSignalCheck1.u, Electrolysis_Constants_storage_el_SOC_threshold)
    annotation (Line(points={{-128,40},{-152,40}}, color={0,0,127}));
  connect(electrolysis_StSp_excess_power_PV.Electrolysis_Constants_tp_TES_max_set,
    inputSignalCheck2.y) annotation (Line(points={{-62,-2},{-82,-2},{-82,-80},{
          -112,-80}}, color={0,0,127}));
  connect(inputSignalCheck2.u, Electrolysis_Constants_T_TES_max_set)
    annotation (Line(points={{-128,-80},{-152,-80}}, color={0,0,127}));
  connect(electrolysis_StSp_excess_power_PV.Electrolysis_Constants_P_el_min,
    inputSignalCheck3.y) annotation (Line(points={{-62,6},{-90,6},{-90,-40},{-112,
          -40}}, color={0,0,127}));
  connect(inputSignalCheck3.u, Electrolysis_Constants_P_el_min)
    annotation (Line(points={{-128,-40},{-152,-40}}, color={0,0,127}));
    connect(const5.y, switch3.u3) annotation (Line(points={{1,-170},{68,-170},
            {68,42},{82,42}}, color={0,0,127}));
  connect(switch1.y, Electrolysis_Specification_Value)
    annotation (Line(points={{281,-10},{310,-10}}, color={0,0,127}));
  connect(electrolysis_StSp_priority_int.Electrolysis_Specification_StSp_priority_int_SI,
    switch4.u2) annotation (Line(points={{-39,-80},{44,-80},{44,-90},{82,-90}},
        color={255,0,255}));
    connect(const5.y, switch4.u3) annotation (Line(points={{1,-170},{68,-170},
            {68,-98},{82,-98}}, color={0,0,127}));
  connect(switch4.u1, signal_Electrolysis_prio_int) annotation (Line(points={{
          82,-82},{-30,-82},{-30,-100},{-152,-100}}, color={0,0,127}));
    connect(const5.y, switch5.u3) annotation (Line(points={{1,-170},{68,-170},
            {68,-138},{82,-138}}, color={0,0,127}));
  connect(electrolysis_StSp_priority_ext.Electrolysis_Specification_StSp_priority_ext_SI,
    switch5.u2) annotation (Line(points={{-39,-40},{44,-40},{44,-130},{82,-130}},
        color={255,0,255}));
  connect(switch5.u1, signal_Electrolysis_prio_ext) annotation (Line(points={{
          82,-122},{-30,-122},{-30,-120},{-152,-120}}, color={0,0,127}));
