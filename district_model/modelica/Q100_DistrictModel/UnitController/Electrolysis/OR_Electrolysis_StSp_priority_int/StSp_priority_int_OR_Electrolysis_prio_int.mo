within Q100_DistrictModel.UnitController.Electrolysis.OR_Electrolysis_StSp_priority_int;
model StSp_priority_int_OR_Electrolysis_prio_int
...
equation
  connect(signal_Electrolysis_prio_int, greaterThreshold.u)
...
end StSp_priority_int_OR_Electrolysis_prio_int;
