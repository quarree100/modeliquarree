...
package FMUs
  ...
  parameter Real ScaleFactor_heatPump1 = 0.8 "Scaling factor for heatpump1";
    ...
    Components.RealOutput_JW y_1315_TRC(final quantity = "ThermodynamicTemperature", final unit = "degC", displayUnit = "degC", min = 0) = temperature_1315_TRC.T - 273.15 annotation(
      Placement(transformation(extent = {{-6, -6}, {6, 6}}, rotation = 180, origin = {-1252, 1148})));
    Components.RealOutput_JW y_1316_TRC(final quantity = "ThermodynamicTemperature", final unit = "degC", displayUnit = "degC", min = 0) = temperature_1316_TRC.T - 273.15 annotation(
      Placement(transformation(extent = {{-1198, 1066}, {-1210, 1078}})));
    Components.RealOutput_JW y_1314_FRC(final quantity = "VolumeFlowRate", final unit = "m3/h", displayUnit = "m3/h", min = 0) = massFlowRate_1314_FRC.dotm * 3600 / 1000 annotation(
      Placement(transformation(extent = {{6, -6}, {-6, 6}}, rotation = 0, origin = {-1272, 1074})));
    Components.RealOutput_JW y_1313_TRC(final quantity = "ThermodynamicTemperature", final unit = "degC", displayUnit = "degC", min = 0) = temperature_1313_TRC.T - 273.15 annotation(
    ...
    Components.RealOutput_JW y_1302_TRC(final quantity = "ThermodynamicTemperature", final unit = "degC", displayUnit = "degC", min = 0) = temperature_1302_TRC.T - 273.15 annotation(
      Placement(transformation(extent = {{-1536, 1066}, {-1548, 1078}})));
    Components.RealOutput_JW y_1304_TRC(final quantity = "ThermodynamicTemperature", final unit = "degC", displayUnit = "degC", min = 0) = temperature_1304_TRC.T - 273.15 annotation(
    ...
    Modelica.Blocks.Interfaces.RealInput u_electrolysis_0_1 annotation(
