...
model Gesamt_Sim
  ...
  Q100_DistrictModel.FMUs.FMU_PhyModel_sorted fMU_PhyModel annotation (
    Placement(visible = true, transformation(extent={{-106,64},{154,264}},    rotation = 0)));
...
connect(const1.y, fMU_PhyModel.u_temperature_heatingGrid_set) annotation (
  ...
  connect(Boiler_disturb.y, fMU_PhyModel.u_disturb_boiler) annotation (Line(
        ...
        ={0,0,127}));
  connect(CHP_disturb.y, fMU_PhyModel.u_disturb_CHP) annotation (Line(points={{
          -379,110},{-366,110},{-366,174.833},{-107.625,174.833}}, color={0,0,
          127}));
