...
model Electrolyser "temperature-controlled electrolysis system"
  ...
  Q100_DistrictModel.Components.ElectrolysisSystem.Tools.Connectors.GasConnector
    port_outlet_o2(redeclare package Gas = O2) annotation (Placement(
      visible=true,
      transformation(extent={{120,80},{160,120}}, rotation=0),
      iconTransformation(extent={{120,80},{160,120}}, rotation=0)));
  Q100_DistrictModel.Components.ElectrolysisSystem.Tools.Connectors.PowerConnector
    port_P_el annotation (Placement(
      visible=true,
      transformation(extent={{-160,120},{-120,160}}, rotation=0),
      iconTransformation(extent={{-160,120},{-120,160}}, rotation=0)));
  // controllers
