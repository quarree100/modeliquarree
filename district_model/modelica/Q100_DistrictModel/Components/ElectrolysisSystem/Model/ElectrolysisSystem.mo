...
model ElectrolysisSystem "electrolysis system with all components and heat pump"
  ...
  // components
  Electrolyser comp_electrolyser(comp_stack(redeclare package O2 = O2, redeclare package
                H2 =                                                                          H2, redeclare CellModel comp_cell(redeclare package
                  H2 =                                                                                                                                 H2, redeclare package
  ...
  Q100_DistrictModel.Components.ElectrolysisSystem.Tools.Components.GasConverter
    gasConverter_H2(redeclare package Gas = Media.Gases.H2andWaterVapor)
    annotation (Placement(visible=true, transformation(extent={{60,60},{80,
            80}}, rotation=0)));
  Q100_DistrictModel.Components.ElectrolysisSystem.Tools.Components.GasConverter
    gasConverter_O(redeclare package Gas = Media.Gases.O2andWaterVapor)
