...
<strong>T_Out:</strong> Output temperature of the boiler. It regulates the mass flow of the pump 
  ...
  connector RealOutput_JW = output Real "'output Real' as connector" annotation(
    ...
    Diagram(coordinateSystem(preserveAspectRatio = true, extent = {{-100.0, -100.0}, {100.0, 100.0}}), graphics = {Polygon(lineColor = {0, 0, 127}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, points = {{-100.0, 50.0}, {0.0, 0.0}, {-100.0, -50.0}}), Text(lineColor = {0, 0, 127}, extent = {{30.0, 60.0}, {30.0, 110.0}}, fontSize = 1, textString = "%name")}),
    Documentation(info = "<html>
<p>
Connector with one output signal of type Real.
  ...
  connector BooleanOutput_JW = output Boolean "'output Boolean' as connector" annotation(
    ...
    Diagram(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}), graphics = {Polygon(points = {{-100, 50}, {0, 0}, {-100, -50}, {-100, 50}}, lineColor = {255, 0, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid), Text(extent = {{30, 110}, {30, 60}}, lineColor = {255, 0, 255}, fontSize = 1, textString = "%name")}),
    Documentation(info = "<html>
  <p>
